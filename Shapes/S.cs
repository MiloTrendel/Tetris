...
namespace Tetris.Shapes
{
    class S : Shape
    {
        ...
        {
            states.Add(0, new ShapeCube[4] {new ShapeCube(Color.Magenta, 1 + x, 1 + y), new ShapeCube(Color.Magenta, 2 + x, 1 + y), new ShapeCube(Color.Magenta, x, 2 + y), new ShapeCube(Color.Magenta, 1 + x, 2 + y)});
            states.Add(1, new ShapeCube[4] {new ShapeCube(Color.Magenta, x, y), new ShapeCube(Color.Magenta, x, 1 + y), new ShapeCube(Color.Magenta, 1 + x, 1 + y), new ShapeCube(Color.Magenta, 1 + x, 2 + y)});
